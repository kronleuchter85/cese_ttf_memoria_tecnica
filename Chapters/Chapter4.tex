...
\begin{center}
\includegraphics[scale=0.23]{demo_product/Lux_100}
  \captionof{figure}{Iluminancia [Lux] reporatada por la aplicación Light Meter en el exterior durante el día.}
  \label{fig:Lux_100}
\end{center}
...
\begin{center}
\includegraphics[scale=0.23]{demo_product/Lux_80}
  \captionof{figure}{Iluminancia [Lux] reporatada por la aplicación Light Meter en interiores durante el día.}
  \label{fig:Lux_80}
\end{center}
...
\begin{center}
\includegraphics[scale=0.23]{demo_product/Lux_0}
  \captionof{figure}{Iluminancia [Lux] reporatada por la aplicación Light Meter en interiores durante la noche.}
  \label{fig:Lux_0}
\end{center}
