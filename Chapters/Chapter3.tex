...
\begin{center}
\includegraphics[scale=1]{schematics/conexionado_fotoresistor_2}
...
\begin{center}
\includegraphics[scale=0.75]{schematics/conexionado_completo_robot_2}
...
\begin{center}
\includegraphics[scale=0.5]{schematics/conexionado_fisico_2}
