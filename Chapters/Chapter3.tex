...
\begin{center}
\includegraphics[scale=0.9]{demo_product/all_perspectives_robot_perspectivas}
...
\begin{center}
\includegraphics[scale=0.8]{demo_product/all_perspectives_robot_arrows_details}
