...
Para el desarrollo de este prototipo se utilizó el SDK de ESP-IDF y se configuró el módulo ADC1 de acuerdo a los detalles provistos en la siguiente tabla \ref{tab:conexionado_fotoresistor}
...
\subsection{Conexionado físico del robot}
